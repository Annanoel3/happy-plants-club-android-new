  ...
  return (
    <div className="min-h-screen flex w-full theme-bg relative">
      ...
      <main className="flex-1 flex flex-col overflow-x-hidden">
        <header className={`border-b theme-border px-6 py-3 sticky top-0 z-10 mobile-header flex-shrink-0 ${!user ? 'hidden' : ''}`} style={{ paddingTop: 'calc(env(safe-area-inset-top, 0px) + 12px)', paddingBottom: '12px' }}>
